        ...
        <div class="row min-vh-100 justify-content-center align-items-center">
            ...
            <div class="col-md-6 col-lg-6">
                <div class= "row d-flex align-items-center justify-content-center">
                    <div class="col-12">
                        <h1 class="my-4 d-flex justify-content-center text-white koreanFont">A N I M A G R A P H</h1>
                        <p class="fs-1 my-4 d-flex justify-content-center text-white bone">A N I M A G R A P H</p>
                        <div class ="col-12 px-5 py-5">
                            <p class="fs-3 my-1 text-left text-white koreanFont">이 이야기에서 어떠한 동기를 찾으려는 자는 기소될 것이다.</p>
                            <p class="fs-5 my-1 text-left text-white bone">persons attempting to find a motive in this narrative will be prosecuted</p>
                            <br>
                            <p class="fs-3 my-1 text-left text-white koreanFont">이 이야기에서 어떠한 교훈을 찾으려는 자는 추방될 것이다</p>
                            <p class="fs-5 my-1 text-left text-white bone">persons attempting to find a moral in this narrative will be banished</p>
                            <br>
                            <p class="fs-3 my-1 text-left d-flex text-white koreanFont">이 이야기에서 어떠한 플롯을 찾으려는 자는 총살될 것이다.</p>
            ...
            <div class="col-md-6 col-lg-6 mt-md-4 mt-lg-0 ">
                ...
                <form class="col-12 px-4 py-4 border border-dark rounded-5 shadow " style = "background-color : white" action = "./function/join.php" method = "post" onsubmit="return validateForm()">
                    <div class="mb-3">
                    ...
                    <div class= "d-flex justify-content-end">
                        <button type="submit" class="btn btn-secondary shadow koreanFont">기록하기</button>
                    </div>
                </form>
            </div>
                </div>
  ...
  <script>
        ...
        function validateForm() {
            ...
            if(usernameValue.length < 20){
                ...
                alert("이름이 너무 깁니다 20자 이내로 입력해주세요.");
                return false;
            }
        }
    </script>
