...
<div class="container min-vh-100">
        <div class="row min-vh-100 justify-content-center align-items-center">
            ...
            <div class="col-md-6 col-lg-6 mt-md-4 mt-lg-0 ">
                ...
                <form class="col-12 px-4 py-4 border border-dark rounded-5 shadow " style = "background-color : white" action = "./function/checkName.php" method = "post" onsubmit="return validateForm()">
                    <div class="mb-3">
